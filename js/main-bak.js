...
myApp.config(['NgAdminConfigurationProvider', function (nga) {
    ...
    var admin = nga.application('My Admin') .baseApiUrl('http://jsonplaceholder.typicode.com/');
    ...
    admin.addEntity(nga.entity('categories'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
    admin.addEntity(nga.entity('products'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
    admin.addEntity(nga.entity('reviews'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
    admin.addEntity(nga.entity('commands'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
  ...
  //  admin.menu(require('./menu')(nga, admin));
   ...
   // admin.addEntity(post);
    admin.addEntity(nga.entity('customers'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
    admin.addEntity(nga.entity('categories'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
    admin.addEntity(nga.entity('products'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
    admin.addEntity(nga.entity('reviews'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
    admin.addEntity(nga.entity('commands'));//.baseApiUrl('http://test.qfplan.com:8888/Admin/'));
    ...
    admin.menu(require('./menu')(nga, admin));
    /*admin.menu(nga.menu()
        .addChild(nga.menu(admin.getEntity('customers')).icon('<span class="glyphicon glyphicon-user"></span>'))
      //.addChild(nga.menu(post).icon('<span class="glyphicon glyphicon-pencil"></span>'))
    );
    */
